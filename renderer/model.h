...
class Model {
public:
    explicit Model(const std::string& path, const Texture& texture = Texture(), const glm::mat4& scale_trans = glm::mat4(1.f));
    explicit Model(const std::string& path, const glm::vec4& color, const glm::mat4& scale_trans = glm::mat4(1.f));
